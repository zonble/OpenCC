...
/usr/libexec/Plistbuddy -c "Add :CFBundleVersion string '1.0.0'" build/Release-universal/OpenCCBridge.framework/Info.plist
/usr/libexec/Plistbuddy -c "Set :CFBundleShortVersionString 1.0.0" build/Release-universal/OpenCCBridge.framework/Info.plist
...
/usr/libexec/Plistbuddy -c "Add :CFBundleVersion string '1.0.0'" build/Release/OpenCCBridge.framework/Resources/Info.plist
